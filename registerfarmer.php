...
if(isset($_POST["submit"]))
{
    $firstName=$_POST["firstName"];
     ...
     $phoneNumber=$_POST["phoneNumber"];
      ...
      if($conn)
      {
      	$sql="INSERT INTO Farmer VALUES('$firstName','$lastName','$farm','$email','$password','$cpassword','$birthDate','$phoneNumber','$radiob')";
      	//$sql="INSERT INTO Farmer VALUES('aarti','lastName',1,'aarti@gmail.com',123,123,1-12-2001,9823319807,'female')";

      	if(mysqli_query($conn,$sql))
      	{
      		echo "<font color='green' size='3'> Farmer Register Sucessfully please login to continue</font>";
      	}
      	else
      	{
